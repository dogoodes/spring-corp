...
public class UnicodeBOMInputStream extends InputStream {
	...
	public static final class BOM {
		 ...
		 */
		public static final BOM UTF_32_MAC = new BOM(new byte[] { (byte) 0xC3, (byte) 0x94, (byte) 0xC2, (byte) 0xAA, (byte) 0xC3, (byte) 0xB8 }, "UTF-32 mac 64 snow leaopard");
	...
	public UnicodeBOMInputStream(final InputStream inputStream) throws NullPointerException, IOException {
		...
		switch (read) {
			case 6:
				if ((bom[0] == (byte) 0xC3) && (bom[1] == (byte) 0x94) && (bom[2] == (byte) 0xC2) && (bom[3] == (byte) 0xAA) && (bom[4] == (byte) 0xC3) && (bom[5] == (byte) 0xB8)) {
